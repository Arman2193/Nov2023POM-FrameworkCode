...
public class RegisterPage {
	...
	
	{
		...
		eleUtil.doActionsClickBy(agreeCheckBox);
		eleUtil.doclick(continueButton);
	String successMgs=	eleUtil.waitForElementVisible(registerSuccessMesg, AppConstants.DEFAULT_MEDIUM_TIME_OUT).getText();
	System.out.println("User reg success msg" +	successMgs);
	
	if(successMgs.contains(AppConstants.USER_REG_SUCCESS_MESSAGE)) {
